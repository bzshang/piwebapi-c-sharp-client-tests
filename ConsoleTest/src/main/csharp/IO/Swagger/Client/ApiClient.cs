...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        public ApiClient(String basePath="https://localhost/piwebapi")
        {
            BasePath = basePath;
        ...
        public FileParameter ParameterToFile(string name, Stream stream, string contentType)
        {
            if (stream is FileStream)
                return FileParameter.Create(name, stream.ReadAsBytes(), Path.GetFileName(((FileStream)stream).Name), contentType);
            else
