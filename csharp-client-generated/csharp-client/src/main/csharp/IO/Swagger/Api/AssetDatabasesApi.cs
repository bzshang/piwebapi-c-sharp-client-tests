...
namespace IO.Swagger.Api
{
    ...
    public interface IAssetDatabasesApi
    {
        ...
        string ExportDatabase (string webId, string exportMode, string startTime, string endTime);
        ...
        /// <param name="endTime">The latest ending time for AFEventFrame, AFTransfer, and AFCase objects that may be part of the export.</param>
        /// <returns>string</returns>
        System.Threading.Tasks.Task<string> ExportDatabaseAsync (string webId, string exportMode, string startTime, string endTime);
        ...
        /// </remarks>
        /// <param name="webId">The ID of the database.</param>
        /// <param name="body">The XML of AF database</param>
        ...
        /// <returns></returns>
        void ImportDatabase (string webId, Body body, string importMode);
        ...
        /// <param name="importMode">Indicates the type of import to perform. The default is &#39;AllowCreate | AllowUpdate | AutoCheckIn&#39;. Multiple import modes may be specified by using multiple instances of importMode.</param>
        /// <returns></returns>
        System.Threading.Tasks.Task ImportDatabaseAsync (string webId, Body body, string importMode);
    ...
    public class AssetDatabasesApi : IAssetDatabasesApi
    {
        ...
        /// <param name="endTime">The latest ending time for AFEventFrame, AFTransfer, and AFCase objects that may be part of the export.</param> 
        /// <returns>string</returns>            
        public string ExportDatabase (string webId, string exportMode, string startTime, string endTime)
        {
        ...
        /// <param name="endTime">The latest ending time for AFEventFrame, AFTransfer, and AFCase objects that may be part of the export.</param>
        /// <returns>string</returns>
        public async System.Threading.Tasks.Task<string> ExportDatabaseAsync (string webId, string exportMode, string startTime, string endTime)
        {
            // verify the required parameter 'webId' is set
            if (webId == null) throw new ApiException(400, "Missing required parameter 'webId' when calling ExportDatabase");
        ...
        /// <param name="importMode">Indicates the type of import to perform. The default is &#39;AllowCreate | AllowUpdate | AutoCheckIn&#39;. Multiple import modes may be specified by using multiple instances of importMode.</param> 
        /// <returns></returns>            
        public void ImportDatabase (string webId, Body body, string importMode)
        {
            ...
            // verify the required parameter 'body' is set
            if (body == null) throw new ApiException(400, "Missing required parameter 'body' when calling ImportDatabase");
        ...
        /// <param name="importMode">Indicates the type of import to perform. The default is &#39;AllowCreate | AllowUpdate | AutoCheckIn&#39;. Multiple import modes may be specified by using multiple instances of importMode.</param>
        /// <returns></returns>
        public async System.Threading.Tasks.Task ImportDatabaseAsync (string webId, Body body, string importMode)
        {
            // verify the required parameter 'webId' is set
            if (webId == null) throw new ApiException(400, "Missing required parameter 'webId' when calling ImportDatabase");
            // verify the required parameter 'body' is set
